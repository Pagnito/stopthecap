...
export default function Wishlist(props) {
  ...
  return (
    <div className="fixed z-40 top-0 flex flex-col justify-center items-center h-screen w-full lg:p-20">
      ...
      <div className="w-0 h-full z-50 bg-white animate-width-open overflow-y-scroll overflow-x-hidden lg:rounded">
      <div className="flex w-full h-full p-10 mt-3 xxs:flex-col lg:flex-row max-w-screen-2xl -translate-y-5 opacity-0 animate-down">
            ...
            <div className="description lg:mt-0 xxs:mt-12 lg:p-10 lg:w-1/2">
             ...
             {viewedProduct.reviews ?  <div className="mt-2 flex items-center">
