...
bg-white-tr-60 "
            ...
            <div className="mr-7 my-icon-style flex rounded-full p-2 border-white border-2 hover:border-red-500 transition-colors cursor-pointer bg-white-tr-60 
bg-white-tr-60 ">
              <RiHeartLine
            ...
            <div className="mr-3 flex rounded-full p-2 border-white border-2 hover:border-red-500 transition-colors cursor-pointer bg-white-tr-60 
bg-white-tr-60 ">
              <RiShoppingBagLine
                className="my-icon-style"
                color="white"
