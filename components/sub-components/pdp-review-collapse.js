...
export default function PdpReviewCollapse(props){ 
  return (
    ...
    <div className="w-full px-4">
       ...
       <button className="border-2 bg-theme-blue border-theme-blue px-3 py-1 rounded hover:bg-green-500 hover:border-green-500 transition-colors text-white mt-2">write a review</button>
    </div>
 </div>
   )
 }