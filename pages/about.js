...
export default function About(props) {
  return (
    <div className="min-h-screen w-full relative box-border lg:px-40 flex flex-col justify-center items-center bg-white">
      ...
      <div className="animate-down opacity-0 translate-y-10  xxs:w-11/12 md:w-full flex sm:flex-col xxs:flex-col-reverse">
        <div className="sm:mt-20 border-2 xxs:mb-10 sm:mb-0 rounded w-full sm:p-10 xxs:p-5">
          <div className="text-2xl text-black">About Us</div>
          <div className="text-red-500 mt-5">Bringing Truth To Market</div>
          <div className="text-black font-rajdhani-md font-bold text-md xxs:leading-6 lg:leading-7 mt-5">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
